...
const SPACE_ICON = "data:image/svg+xml;base64,";
...
const PROJECTS = [
  ...
  { name:"Space Commanders", tagline:"Classic arcade shooter, rebuilt for the browser.", description:"Wave-based space invaders with power-ups, multiple enemy types, and leaderboard. How long can you survive?", url:"https://space-commanders-classic.anaken.one/", icon:null, imgIcon:SPACE_ICON, tag:"game", index:"03" },
  { name:"Simple Snake", tagline:"Classic snake game, built with you.", description:"A clean browser-based snake game. Use arrow keys or swipe to play — how high can you score?", url:"https://simple-snake.anaken.one/", icon:null, imgIcon:SNAKE_ICON, tag:"game", index:"04" },
];
...
export default function ClientApp({ articles = [] }) {
  ...
  const [activeSection,setActiveSection] = useState(() => {
    ...
    const valid = ["intro","news","articles","projects","contact"];
  ...
  // Init openArticle from hash (e.g. #articles/some-slug)
  useEffect(()=>{
    const h = window.location.hash.replace("#","");
    const parts = h.split("/");
    if(parts[0]==="articles" && parts[1] && articles.length>0){
  ...
  useEffect(()=>{
    const onHashChange = () => {
      ...
      const parts = h.split("/");
      const valid = ["intro","news","articles","projects","contact"];
      const sec = valid.includes(parts[0]) ? parts[0] : "intro";
      setActiveSection(sec);
      if(sec==="articles" && parts[1]){
        const found = articles.find(a=>a.slug===parts[1]);
        setOpenArticle(found||null);
      } else {
        setOpenArticle(null);
      }
    };
          ...
          <section style={{ animation:"fadeIn 0.4s ease" }}>
            {openArticle ? (
              ...
              <div>
                ...
                {shareModal && (
                  <div style={{ position:"fixed",inset:0,zIndex:200,background:"rgba(0,0,0,0.7)",display:"flex",alignItems:"center",justifyContent:"center",padding:"16px" }}
                    ...
                    <div style={{ background:isDark?"#0e1a14":t.bg,border:`1px solid ${t.borderHover}`,padding:"28px",width:"100%",maxWidth:"400px",position:"relative" }}>
                      ...
                      <div style={{ display:"flex",gap:"8px",marginBottom:"24px" }}>
                        <div style={{ flex:1,background:t.bgInput,border:`1px solid ${t.borderInput}`,padding:"10px 12px",fontSize:"11px",color:t.textDim,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap",fontFamily:"'Courier New',monospace" }}>
                          {`https://anaken.one/#articles/${openArticle.slug}`}
                        </div>
                        <button onClick={()=>{ navigator.clipboard.writeText(`https://anaken.one/#articles/${openArticle.slug}`); setShareCopied(true); setTimeout(()=>setShareCopied(false),2000); }}
                      ...
                      <div style={{ display:"flex",flexDirection:"column",gap:"2px" }}>
                        {[
                          { icon:"𝕏", label:"Share on X", sub:"Post to your followers", href:`https://twitter.com/intent/tweet?url=${encodeURIComponent("https://anaken.one/#articles/"+openArticle.slug)}&text=${encodeURIComponent(openArticle.title)}` },
                          { icon:"in", label:"Share on LinkedIn", sub:"Post to your network", href:`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent("https://anaken.one/#articles/"+openArticle.slug)}` },
                          { icon:"✉", label:"Share via Email", sub:"Send to a colleague", href:`mailto:?subject=${encodeURIComponent(openArticle.title)}&body=${encodeURIComponent("https://anaken.one/#articles/"+openArticle.slug)}` },
                        ].map((opt,i)=>(
              ...
              <div>
                ...
                {articles.length === 0 ? (
                  <p style={{ color:t.textDim,fontSize:"13px" }}>No articles yet.</p>
                ) : (
                  <div style={{ display:"flex",flexDirection:"column",gap:"2px" }}>
